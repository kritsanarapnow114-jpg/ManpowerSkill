...
export const api = {
  ...
  setTaskAssignmentDone: (assignmentId, done) => request(`/api/tasks/assignments/${assignmentId}`, json("PATCH", { done })),
  deleteTaskAssignment: (assignmentId) => request(`/api/tasks/assignments/${assignmentId}`, { method: "DELETE" }),
